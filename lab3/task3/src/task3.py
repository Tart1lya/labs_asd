...
from lab2.utils import *  # Импортируем функции для чтения и записи файлов
...
if __name__ == "__main__":
    ...
    (n_and_k_str, m) = open_file(input_path)  # Считываем данные из файла: первое число n и k, далее массив матрешек
    ...
    if (1 <= n <= 10 ** 5) and (all(abs(i) <= 10 ** 9 for i in m)) and (1 <= k <= 10 ** 5):
        ...
        write_file(result, output_path)  # Записываем ответ ("ДА" или "НЕТ") в файл output.txt
    else:
