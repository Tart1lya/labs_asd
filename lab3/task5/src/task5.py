...
def h_index(citations):
    ...
    # Проходим по отсортированному списку и находим максимальное значение h,
    # которое выполняет условие h <= цитированию на позиции i
    for i in range(len(citations)):
        if citations[i] < i + 1:
            return i  # Возвращаем индекс h, если условие нарушено
...
if __name__ == "__main__":
    ...
    citations = citations_str[0]  # Используем первую строку, предполагая, что это массив цитирований
